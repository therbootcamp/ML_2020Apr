...
<ul>
  <li class="m1"><span><high>Deep learning</high> (insbesondere Convolutional Neural Networks) sind besonders gut darin, <high>Feature selber zu entwickeln</high>.</span></li><br>
  <li class="m2"><span>Das <mono>tensorflow</mono> Paket bietet Zugang zu mächtigen <high>Tensorflow</high> Library für Deep Learning von Google.</span></li><br>
</ul>
...
<tr style="background-color:#ffffff">
  ...
  <td align="center">Vergrösser Fehlertoleranz</td>
...
<ul>
  <li class="m1"><span><high>Aggregieren</high> der Vorhersagen multipler Modelle, die auf Basis <high>Stichproben</high> aus den Daten gefitted werden.</span></li><br>
...
<ul>
  ...
  <ul>
    <li><span>Feature müssen nicht für die Vorhersage verwendet werden (bei hohem <mono>mtry</mono>).</span></li>
  <ul>
</ul>
