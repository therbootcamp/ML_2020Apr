...
<ul>
  <li class="m1"><span>Die rekursive Featureselektion <mono>rfe()</mono> verwendet Cross-Validation um die besten <i>n</i> Feature zu identifizieren.</span></li>
...
<ul>
  <li class="m1"><span>Das <high>Standardmodell</high> für Dimensionsreduktion.</span></li>
  <li class="m2"><span>Verwendet ein lineares (Regression) um die Feature in einem <high>neuen, kleineren Featureraum</high> zu re-representieren.</span></li>
  <li class="m3"><span>Der neue Featureraum wird so gewählt, dass er die <high>maximal mögliche Varianz an den ursprünglichen Featuren präserviert.</span></li>
</ul>
