...
<ul>
  <li class="m1"><span>Die rekursive Featureselektion <mono>rfe()</mono> verwendet <high>Cross-Validation</high> um die besten <i>n</i> Feature zu identifizieren.</span></li>
  ...
  <ol>
    ...
    <li><span>Evaluiere <high>Vorhersageleistung</high> für jeweils die besten <mono>n</mono> Feature.</span></li>
...
<ul>
  ...
  <li class="m2"><span>Verwendet ein lineares (Regression) um die Feature in einem <high>neuen, kleineren Featureraum</high> zu re-representieren.</span></li><br>
  <li class="m3"><span>Der neue Featureraum wird so gewählt, dass er die <high>maximal mögliche Varianz</high> an den ursprünglichen Featuren präserviert.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Multikollinearität bedeutet, dass Feature zu stark korreliert sind, was in schädlicher Redundanz, <high>instabile Fits resultiert</high>, und <high>schlechtere Vorhersagen führt</high>.</span></li>
</ul>

```{r}
# Identifiziere redundante Feature
findCorrelation(cor(basel))

# Entferene redundante Feature
...
<ul>
  <li class="m2"><span>Ungleiche Varianzen <high>verzerren</high> Methoden, die gleiche Varianz erwarten (z.B. Lassos).</span></li>
</ul>

```{r, eval = F}
# Standardisiere Feature
train(..., preProc("center", "scale"))
```

<ul>
  <li class="m3"><span>Feature ohne "Varianz" tragen nicht zur Vorhersage bei, aber <high>vergrössern die Komplexität des Modells.</span></li>
</ul>
...
<ul>
  <li class="m1"><span><b>Triviale Feature</b></span></li>
  <ul>
    <li><span>Erfolgreiche Vorhersage bedeutet nicht, dass ein <high>bedeutsames Muster</high> identifiziert wurde</span></li>
  </ul><br>
  <li class="m2"><span><b>Fehlende Feature</b></span></li>
  <ul>
    <li><span>Erfolgreiche Vorhersage basiert i.d.R. auf der Entwicklung <high>neuer, relvanterer Feature</high>.</span></li><br>
  </ul>
</ul>
