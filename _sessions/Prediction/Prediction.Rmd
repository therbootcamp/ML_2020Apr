...
<br>
<p align = "center"><font size = 6><i>"Könnt ihr euch ein Modell vorstellen, dass perfekten Fit im Training liefert und in der Vorhersage nutzlos ist?"</i></font><br><br>
...
<ul>
  <li class="m1"><span>Tritt ein, wenn ein model die <high>Daten zu genau fitted</high> und deswegen <high>keine guten Vorhersagen</high> liefert.</span></li><br>
...
<ul>
  <li class="m1"><span>Classification und regression trees werden mit dem folgen <high>Algorithmus</high> gefitted:</span></li><br>
  <ul>
...
<ul>
  <li class="m1"><span>Classification trees versuchen ingesamt <highm>impurity</highm> zu minimieren.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Classification trees werden schluessendlich <high>gestutzt (pruned)</high> so dass jedes Auftrennen eines Knoteeens einen gain von mindestens <highm>cp</highm>.</span></li>
</ul>
...
<ul>
  ...
  <ul>
  <li><span>1 - <high>Trenne</high> Knoten, so dass der grösste <high>Zugewinn an Homogenität entsteht</high>.</li></span><br>
    <li><span>2 - <high>Wiederhole</high> bis zu einer vordefinierten Schwelle (zB. <mono>minsplit</mono>).</span></li><br>
  <li><span>3 - <high>Stutze</high> den Baum gemäss <mono>complexity parameter</mono></span></li>
  <ul>
</ul>
...
<ul>
  <li class="m1"><span>Fitte eine decision tree in <mono>caret</mono> mit <highm>method = "rpart"</highm>.</span></li>
...
<ul>
  ...
  <li><span>2 - <high>Fitte</high> nicht-gestutzte Entscheidungsbäume.<br><br>Berücksichte bei jeder Auftrennung nur <high><mono>m</mono> Feature</high>.</span></li><br>
  </ul>
  <li><span>2 - <high>Mittele</high> die gefitteten Werte.</li></span><br>  
  </ul>
</ul>
...
<ul>
  <li class="m1"><span>Random Forests bedienen sich des <high>Baggings</high> (<high>Resampling</high> und <high>Averaging</high>) um höre Vorhersageleistungen zu erzielen.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Fitte eine Random Forest in <mono>caret</mono> mit <highm>method = "rf"</highm>.</span></li>
...
<tr>
  ...
  <td bgcolor="white">
    Testdaten (Muss alle Featuree in <mono>object</mono> beinhalten).    
  </td>  
</tr>
</table>
