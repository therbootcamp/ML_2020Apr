...
<ul>
  <li class="m1"><span>Classification trees werden schlussendlich <high>gestutzt (pruned)</high> so dass jedes Auftrennen eines Knotens einen gain von mindestens <highm>cp</highm>.</span></li>
</ul>
...
`caret` wird <high> automatisch </high> wählen, ob Klassifikations- oder Regressionsbäume verwendet werden sollen, je nachdem, ob das Kriterium ein `factor` ist oder nicht.
