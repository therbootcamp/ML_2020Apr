...
1. Using the code below, fit a regression model predicting graduation rate (`Grad.Rate`) as a function of one feature `PhD` (percent of faculty with PhDs). Save the result as an object `Grad.Rate_glm`.
