...
<ul>
  <li class="m1"><span><mono>train()</mono> ist <mono>caret</mono>'s <high>Zugpferd</high>, wenn es um Fitting geht. Damit können <high>über 200 Modelle</high> gefittet werden, wofür man jeweils nur das <high>method</high> Argument anpassen muss.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Die <mono>confusionMatrix()</mono> Funktion erstellt eine Zusammenfassung der Modellperformanz bei <high>Klassifikationsproblemen</high>. Zu spezifizierende Argumente sind wiederum die vorhergesagten Werte und die tatsächlichen Werte.</span></li>
</ul>
