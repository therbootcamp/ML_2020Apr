...
<ul style="margin-bottom:-20px">
  ...
  <ul class="level">
    <li><span>LogLoss – ein Distanzmass wie MSE und MAE – wird i.A.R. <high>zum Fitten von Parametern</high>, verwendet.</span></li>
  </ul>
</ul>
...
<ul>
  ...
  <ul class="level">
    <li><span>Die 0-1 loss function testet, ob die <high>vorhergesagte Kategorie, der tatsächlichen Kategorie entspricht</high>. Sie ist <high>leichter zu interpretieren</high>.</span></li>
  </ul>
</ul>
