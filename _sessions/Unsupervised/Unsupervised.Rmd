...
<ul>
  <li class="m1"><span>Hans Rosling's Gapminder Projekt kartographiert die <high>gesundheitlich und ökonomische Entwicklung in den Ländern</high> der Welt.</span></li>
...
<ul>
  <li class="m1"><span>Gibt es <high>in 1952 Klassen von Ländern</high> gemäss Lebenserwartung und BIP per Kopf in 1952?</span></li><br>
...
<ul>
  ...
  <ol class="">
    ...
    <li><span>Cases dem nächstgelegenen <high>Klassenzentroide zuweisen</high>.</span></li><br>
...
<ul>
  <li class="m1"><span>Eine <high>probabilistische Erweiterung des <i>k</i>-means Algorithmus</high> auf Basis des multivariater Normalverteilungen</span></li>
  <li class="m2"><span>Guter Umgang mit Clustern <high>verschiedener Orientierungen und Dichten</high></span></li>
    ...
    <li class="m4"><span>Komplexe "Topologien" machen Gaussian mixtures jedoch Schwierigkeiten</span></li>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Guter Umgang mit Clustern <high>verschiedener Orientierungen und Dichten</high></span></li>
    <li class="m3"><span><high>Einfache Schätzung <i>k</i></high>über Modellvergleiche</span></li>
    <li class="m4"><span><high>Komplexe "Topologien"</high> machen Gaussian mixtures jedoch Schwierigkeiten</span></li>
</ul>
