...
<div class="my-footer">
  <span style="text-align:center">
    ...
    <a href="https://therbootcamp.github.io/">
      <font color="#7E7E7E">
      Machine Learning mit R | April 2020
      </font>
    </a>
    </span>
  </div> 
...
<ul>
  <li class="m1"><span>Overfitting tritt ein, wenn ein model die <high>Daten zu genau fitted</high> und deswegen <high>keine guten Vorhersagen</high> liefert</span></li><br>
  <li class="m2"><span>Gute Performanz in Training bedeutet also nicht unbedingt <high>gute Performanz in Test</high>.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Die meisten ML Modelle besitzen Tuning Parameter, die die  Modellkomplexität kontrollieren</span></li><br>
  <li class="m2"><span>Um diese Tuning Parameter zu fitten wird ein <high>Validationsdatensatz</high> kreiert.</span></li>
  <li class="m3"><spanVorgehen:</span></li>  
  <ol>
    <li><span>Fitte Modell mit verschiedenen Werten für die Tuning Parameter</span></li>
    <li><span>Auf Basis des Validationsdatensatzes wähle die besten Tuning Parameter</span></li>
    <li><span>Fitte Modell für gesamten Traningsdatensatz.</span></li>
  </ol>
</ul>
...
<ul>
  <li class="m1"><span>Resampling-Methoden automatisieren und generalisieren das das Tuning der Modelle</span></li><br>
</ul>
...
<tr>
  ...
  <td bgcolor="white">
    Trennt die Daten in <i>k</i>-Teile, verwendet <high>jeden Teil einmal</high> als Validationset, während die restlichen Teile <i>k-1</i> als Trainingset dienen. 
  </td>  
</tr>
<tr>
  <td bgcolor="white">
...
<ul>
  <li class="m1"><span>Bestraft proportional zum <high>Tuning parameter &lambda;</high> den Loss einer Regression für die Grösse der Modellparameter</span></li><br>
</ul>
...
Specify the <high>type of penalty</high> and the <high>penalty weight</high> using the <mono>tuneGrid</mono> argument. 
...
Random Forests have a <high>diversity parameter</high> called <mono>mtry</mono>.
...
Specify the tuning parameter values to consider using the <high><mono>tuneGrid</mono></high>.

<mono>tuneGrid</mono> expects a <high>list or data frame</high> as input. 

<high>Parameter combinations</high> can be easily created using <mono>expand.grid</mono>.
...
<h1><a href=https://therbootcamp.github.io/ML_2019Oct/_sessions/Optimization/Optimization_practical.html>Practical</a></h1>
