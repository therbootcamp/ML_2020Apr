...
<ul>
  <li class="m1"><span>Resampling-Methoden <high>automatisieren</high> und generalisieren das das Tuning der Modelle</span></li><br>
</ul>
...
<tr>
  ...
  <td bgcolor="white">
    Niedrige Strafe, die zu <high>komplexen Bäumen</high> fürht.
  </td> 
</tr>
<tr>
  <td bgcolor="white">
...
<ul>
  ...
  <ul>
    <li><span>Identifiziere durch 10-fache Cross Validation die <high>besten Regularisierungsparameter</high> für ein Rgressionsmodell</span></li><br>
  </ul>
...
<ul>
  ...
  <li class="m2"><span><mono>tuneGrid</mono> eine <mono>liste</mono> oder einen <mono>data.frame</mono>; komfortable durch <mono>expand.grid()</mono> erstellt</span></li><br>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Die <mono>summary()</mono> des Objekts gibt einen ausführlichen <high>Überblick</high> über die Performnz.</span></li><br>
</ul>
