...
<ul>
  ...
  <ul class="level">
    ...
    <li><span><i>Wie entscheidet ihr, ob der Patient einen Herzinfarkt habt oder nicht?</i></span></li>
  </ul>
  <br><br>
  ...
  <ul class="level">
    ...
    <li><span>Wie entscheidet ihr, ob prospektive Verkauszahlen eine neue Filiale rechtfertigen?</span></li>
  </ul>
</ul>
...
<ul>
  ...
  <br>
  <ul class="level">
    <li><span>...verrät wenig darüber <high>wie die Vorhersage zustande gekeommen ist</high>.</span></li><br>
...
<ul>
  ...
  <li class="m2"><span>Wir fokussieren den auf den Bereich des <high>Supervised Learning</high> (Deutsch: überwachtes Lernen).</span></li>
</ul>
...
<tr>
  <td bgcolor="white">
    <i>Criterion<br><font style="font-size:12px">(Variable, Kriterion)</font></i>
  </td>
  <td bgcolor="white">
   Das <high>Feature</high>, dass man <high>vorhersagen</high> will.
  </td>  
  <td bgcolor="white">
...
<ul>
  ...
  <li class="m2"><span>Supervised learning benötigt <high>gelabelte Daten</high> um ein <high>Modell</high> zu lernen, dass das Criterion in Beziehung zu den Features setzt.</span></li>
</ul>

<br>
<u>Beispiel in Worten</u>

<p style="margin-left:20px"><font style="font-size:24px">Wenn <mono>cp</mono> (chest pain) is nicht <mono>a</mono> (asymptomatic) and <mono>age</mono> ist grösser als <mono>60</mono> dann ist die Wahrscheinlichkeit für einen Herzinfarkt gross, anderfalls niedrig.</font></p>
