...
<ul>
  ...
  <ul class="level">
    <li><span><high>Feld der Mathematik</high>, dass sich mit der Erhebung, Verarbeitung, Analyse, und Interpretation von Daten beschäftigt.</span></li>
  </ul>
  ...
  <ul class="level">
    <li><span>Multi-disziplinares Feld, dass sich mit Methoden und Systemen zur Extraktion von <high>Erkenntnissen aus Daten</high> beschäftigt</span></li>
  </ul>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Supervised learning benötigt <high>gelabelte Daten</high> um ein <high>Modell</high> zu lernen, dass das Kriterium in Beziehung zu den Features setzt.</span></li>
</ul>
